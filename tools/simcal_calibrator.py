...
if __name__=="__main__":
	...
	parser.add_argument("-x", "--XRootD", type=str,  help="XRootD Block size to use", default = 10_000_000_000)
	parser.add_argument("-n", "--network", type=float, help="Network Buffer size to use", default = 0)
