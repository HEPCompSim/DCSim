...
if __name__=="__main__":
	...
	parser.add_argument("-x", "--XRootD", type=int,  help="XRootD Block size to use", default = 10_000_000_000)
	parser.add_argument("-n", "--network", type=int, help="Network Buffer size to use", default = 0)
