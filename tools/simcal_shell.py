...
if __name__=="__main__":
	...
	parser = argparse.ArgumentParser(description="Calibrate DCSim using simcal\n./simcal_shell.py -l chamfer -t 60 -c `nproc` -g ../../hep-testjob/ -a \"{'cpuSpeed': 2013316592.69, 'ramDisk': 520603672718.03, 'disk': 31870835.63, 'internalNetwork': 612634952.36, 'xrootd_flops': 3615900.89, 'externalFastNetwork': 1435159079.45, 'externalSlowNetwork': 218960749.30}\" -d 2172.5 -s 4255 -f ./shell")
	...
	parser.add_argument("-f", "--dir", type=str, help="folder to save shell too",default="")
